...
var _DataTablesFooter = require('./DataTablesFooter');

var _DataTablesFooter2 = _interopRequireDefault(_DataTablesFooter);
...
var DataTables = function (_Component) {
  ...
  function DataTables(props, context) {
    ...
    _this.renderTableFooterTotalData = function (value, column) {
      return column.totalRender ? column.totalRender(value) : column.render ? column.render(value) : value;
    };
...
DataTables.propTypes = {
  ...
  showFooterRow: _propTypes2.default.bool,
